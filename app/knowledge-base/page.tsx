              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      placeholder="Enter concepts, equations, or keywords..."
                      value={searchQuery}
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    <Button
                      ...
                      onClick={() => setSearchQuery("quantum entanglement")}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="w-full justify-start text-xs bg-transparent"
                      onClick={() => setSearchQuery("Einstein field equations")}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="w-full justify-start text-xs bg-transparent"
                      onClick={() => setSearchQuery("Schrödinger equation")}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="w-full justify-start text-xs bg-transparent"
                      onClick={() => setSearchQuery("thermodynamic laws")}
                    >
                      Thermodynamic Laws
                    </Button>
                  </div>
                      ...
                      <Card key={result.id || index} className="p-4">
                        ...
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => handleExplain(result.concepts[0] || result.title)}
                          >
                            Explain Concept
                          </Button>
                    ...
                    <CardContent className="p-8 text-center">
                      ...
                      <div className="flex flex-wrap gap-2 justify-center">
                        <Badge
                          ...
                          onClick={() => setSearchQuery("quantum mechanics")}
                        >
                          Quantum Mechanics
                        </Badge>
                        <Badge
                          variant="outline"
                          className="cursor-pointer"
                          onClick={() => setSearchQuery("relativity")}
                        >
                          Relativity
                        </Badge>
                        <Badge
                          variant="outline"
                          className="cursor-pointer"
                          onClick={() => setSearchQuery("thermodynamics")}
                        >
                          Thermodynamics
                        </Badge>
                        <Badge
                          variant="outline"
                          className="cursor-pointer"
                          onClick={() => setSearchQuery("electromagnetism")}
                        >
                          Electromagnetism
                        </Badge>
                      </div>
