...
import { Activity, Database, FileText, Brain, Server, TrendingUp, RefreshCw, CheckCircle, XCircle, AlertCircle, } from "lucide-react";
export default function AdminDashboard() {
    ...
    const getStatusBadge = (status, label) => (<Badge variant={status ? "default" : "destructive"} className="flex items-center gap-1">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <Badge variant={health.status === "healthy" ? "default" : "destructive"} className="flex items-center gap-1 w-fit">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="knowledge" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {stats?.knowledge.topicDistribution.map((topic, index) => (<div key={index} className="flex items-center justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {stats?.knowledge.difficultyDistribution.map((difficulty, index) => (<div key={index} className="flex items-center justify-between">
        ...
        <TabsContent value="documents" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            Object.entries(stats.documents.fileTypes).map(([type, count]) => (<div key={type} className="flex items-center justify-between">
        ...
        <TabsContent value="analysis" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            Object.entries(stats.analysis.agentDistribution).map(([agent, count]) => (<div key={agent} className="flex items-center justify-between">
