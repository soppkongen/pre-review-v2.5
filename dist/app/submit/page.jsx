    ...
    return (<div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${dragActive ? "border-teal-500 bg-teal-50" : "border-gray-300 hover:border-gray-400"}`} onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop}>
              {file ? (<div className="flex items-center justify-center gap-2">
              ...
              <input type="file" className="hidden" id="file-upload" accept=".pdf,.tex,.docx" onChange={handleFileSelect}/>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <Textarea placeholder="In 1-2 sentences, describe your paper's core idea..." value={summary} onChange={(e) => setSummary(e.target.value)} className="min-h-[100px]"/>
        ...
        <div className="flex gap-4">
          ...
          <Button className="flex-1 bg-teal-600 hover:bg-teal-700" disabled={!file || isSubmitting} onClick={handleSubmit}>
            {isSubmitting ? (<>
