...
export default function TheoryBootloaderPage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
              ...
              <CardContent>
                <Tabs defaultValue="text" className="w-full">
                  ...
                  <TabsContent value="text" className="space-y-4">
                    <Textarea placeholder="Describe your concept, theory, or idea in any format. You can include equations, references, or just rough thoughts..." value={concept} onChange={(e) => setConcept(e.target.value)} className="min-h-[200px] text-base"/>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-500">{concept.length} characters</span>
                      <Button onClick={handleAnalyze} disabled={!concept.trim() || isAnalyzing} className="bg-indigo-600 hover:bg-indigo-700">
            ...
            {/* Analysis Progress */}
            {isAnalyzing && (<Card className="mt-6">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
            ...
            {/* Analysis Results */}
            {analysisResults && (<Card className="mt-6">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {analysisResults.domains.map((domain, index) => (<Badge key={index} variant="outline">
                          {domain}
                        </Badge>))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {analysisResults.gaps.map((gap, index) => (<li key={index} className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {analysisResults.suggestions.map((suggestion, index) => (<li key={index} className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {analysisResults.relatedTheories.map((theory, index) => (<Badge key={index} className="bg-purple-100 text-purple-800 hover:bg-purple-200">
                          {theory}
                        </Badge>))}
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button variant="outline" className="w-full text-left justify-start h-auto p-3 bg-transparent" onClick={() => setConcept("What if quantum entanglement could be used to transmit information faster than light through manipulation of vacuum energy fluctuations?")}>
                  <div>
                ...
                <Button variant="outline" className="w-full text-left justify-start h-auto p-3 bg-transparent" onClick={() => setConcept("Could dark matter be explained by extra-dimensional gravitational effects that only manifest at galactic scales?")}>
                  <div>
                ...
                <Button variant="outline" className="w-full text-left justify-start h-auto p-3 bg-transparent" onClick={() => setConcept("Time dilation effects near black holes might create closed timelike curves that could explain quantum measurement collapse")}>
                  <div>
